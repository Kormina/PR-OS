...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    HBITMAP hBitmap = (HBITMAP)LoadImage(NULL, L"..//WindowsProject/круг.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    BITMAP Bitmap;
    ...
    case WM_PAINT: {
        ...
        HDC hdc = BeginPaint(hWnd, &ps);
        {
            ...
            TransparentBlt(hdc, (width - width_img)/2,0, width_img, height_img, hCompatibleDC,0, 0, width_img, height_img, RGB(255, 255, 255));
